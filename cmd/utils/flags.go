...
// This file is part of go-etherfact.
//
...
// Package utils contains internal helper functions for go-etherfact commands.
package utils
...
import (
	...
	"github.com/EtherFact-Project/go-etherfact/common/fdlimit"
	"github.com/EtherFact-Project/go-etherfact/consensus"
	"github.com/EtherFact-Project/go-etherfact/consensus/clique"
	...
	"github.com/EtherFact-Project/go-etherfact/dashboard"
	...
	"github.com/EtherFact-Project/go-etherfact/ethstats"
	"github.com/EtherFact-Project/go-etherfact/les"
	...
	"github.com/EtherFact-Project/go-etherfact/p2p/nat"
	"github.com/EtherFact-Project/go-etherfact/p2p/netutil"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `getf account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Welcome to GetF of EtherFact Version v1.8.6 Good Luck and Mining")
...
// new format.
//
// e.g. getf account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// getf --keystore /tmp/mykeystore --lightkdf account new
//
